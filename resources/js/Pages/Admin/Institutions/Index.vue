...
const reorderRows = (event: { value: AdminInstitution[] }) => {
    postReorderedRows(route("admin.institution.order"), event.value);
};
...
<template>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        ...
        >
            <template #header>
                <div class="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <div class="flex flex-wrap justify-between gap-2">
                        <label for="institutions-global-search" class="sr-only">
            ...
            <Column
                :field="(i) => translate(i.title) ?? ''"
                :sortable="true"
                :header="$t('admin.institutions.index.table.header.title')"
            />
            <Column
                field="short_title"
                :sortable="true"
